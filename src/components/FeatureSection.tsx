...
import { Users, TrendingUp, Rocket, Target, Sparkles, BarChart3, Zap, ChevronDown, ChevronUp, ArrowRight, LucideIcon } from "lucide-react";
...
const FeatureCard = ({ title, description, items, icon: Icon }: FeatureCardProps) => {
...
export default function FeatureSection() {
  const frontendItems: FeatureItem[] = [
  ...
  const backendItems: FeatureItem[] = [
